...
<#
    ...
    Try {
        ...
        [String]$TempFolderName = [System.IO.Path]::GetTempFolderName() -replace '.*\\', ''

        [String]$TempFolderPath = "{0}{1}" -f $OutputFolderDirectoryPath, $TempFolderName

        New-Item -Path $TempFolderPath -type Folder | Out-Null
    ...
    If ( [String]::IsNullOrEmpty($OutputFolderNameSuffix)) {
        ...
        [String]$OutputFolderPathTemp = "{0}.{1}" -f $OutputFolderPathTemp1, $OutputFolderNameExtension

    }
    Else {

        [String]$OutputFolderPathTemp = "{0}{3}{1}.{2}" -f $OutputFolderTemp1, $OutputFolderNameSuffix, $OutputFolderNameExtension,$NamePartsSeparator
    ...
    If ($ErrorIfOutputFolderExist -and (Test-Path -Path $OutputFolderPath -PathType Leaf)) {
