...
<#
    ...
    .SYNOPSIS
    Function intended for preparing a file name for output files like reports or logs.

    .DESCRIPTION
    Function intended for preparing a file name for output files like reports or logs based on prefix, middle name part,
    suffix, date, etc. with verification if provided path is writable.
    ...
    - 0.8.2 - 2016-06-10 - Help updated, empty Pester tests file added
    
    REMARKS
    - The warning generated by PSScriptAnalyzer "Function 'New-OutputFile' has verb that could change system state. Therefore, the function has to support 'ShouldProcess'." is acceptable.
